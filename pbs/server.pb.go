...
type ClientPeer struct {
	...
	Relays            []*pb.HostPort         `protobuf:"bytes,4,rep,name=relays,proto3" json:"relays,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
var file_server_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x61, 0x79, 0x73, 0x22, 0xc0, 0x01, 0x0a, 0x0a, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x50, 0x65, 0x65, 0x72, 0x12, 0x2d, 0x0a, 0x12, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x63,
	...
	,
	...
	0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x2a, 0x0a, 0x07, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x73,
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x2e,
	0x41, 0x64, 0x64, 0x72, 0x50, 0x6f, 0x72, 0x74, 0x52, 0x07, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74,
	0x73, 0x12, 0x28, 0x0a, 0x06, 0x72, 0x65, 0x6c, 0x61, 0x79, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x10, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x2e, 0x48, 0x6f, 0x73, 0x74, 0x50,
	0x6f, 0x72, 0x74, 0x52, 0x06, 0x72, 0x65, 0x6c, 0x61, 0x79, 0x73, 0x22, 0x62, 0x0a, 0x05, 0x52,
	0x65, 0x6c, 0x61, 0x79, 0x12, 0x2a, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18,
...
var file_server_proto_goTypes = []any{
	...
	(*Relay)(nil),             // 6: server.Relay
	(*Request_Announce)(nil),  // 7: server.Request.Announce
	(*Request_Relay)(nil),     // 8: server.Request.Relay
	(*Response_Announce)(nil), // 9: server.Response.Announce
	(*Response_Relays)(nil),   // 10: server.Response.Relays
	(*pb.Error)(nil),          // 11: shared.Error
	(*pb.AddrPort)(nil),       // 12: shared.AddrPort
	(*pb.HostPort)(nil),       // 13: shared.HostPort
	(*pb.Forward)(nil),        // 14: shared.Forward
	(pb.Role)(0),              // 15: shared.Role
}
var file_server_proto_depIdxs = []int32{
	...
	7,  // 2: server.Request.announce:type_name -> server.Request.Announce
	8,  // 3: server.Request.relay:type_name -> server.Request.Relay
	11, // 4: server.Response.error:type_name -> shared.Error
	9,  // 5: server.Response.announce:type_name -> server.Response.Announce
	10, // 6: server.Response.relay:type_name -> server.Response.Relays
	12, // 7: server.ClientPeer.directs:type_name -> shared.AddrPort
	13, // 8: server.ClientPeer.relays:type_name -> shared.HostPort
	12, // 9: server.ServerPeer.directs:type_name -> shared.AddrPort
	13, // 10: server.ServerPeer.relays:type_name -> shared.HostPort
	13, // 11: server.Relay.address:type_name -> shared.HostPort
	14, // 12: server.Request.Announce.forward:type_name -> shared.Forward
	15, // 13: server.Request.Announce.role:type_name -> shared.Role
	4,  // 14: server.Request.Announce.peer:type_name -> server.ClientPeer
	14, // 15: server.Request.Relay.forward:type_name -> shared.Forward
	15, // 16: server.Request.Relay.role:type_name -> shared.Role
	5,  // 17: server.Response.Announce.peers:type_name -> server.ServerPeer
	6,  // 18: server.Response.Relays.relays:type_name -> server.Relay
