...
pkgs.buildGoModule
{
  ...
  vendorHash = "sha256-5f63K5NPxPgORWf0dDSmWjAeS56JsKvQMU9rpxoOo5k=";
  subPackages = [ "cmd/connet" ];
  ldflags = [ "-X 'github.com/connet-dev/connet/pkg/build.Version=${lib.strings.fileContents ../VERSION}'" ];
