...
metadata = "home" # metadata associated with this client, to help distinguish different clients
...
metadata = "home" # metadata associated with this relay, to help distinguish different relays
